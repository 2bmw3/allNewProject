			...
			<div id="main-container-image">
				...
				<c:if test="${'[null]' ne list}">
					<c:forEach items="${list}" var="vo">
						...
						<a href="thema${vo.thema}/view?shopname=${vo.shopname}&pno=${vo.pno}&jspName=/${actionName}&sType=${sType}&keyword=${keyword}" onclick="window.open(this.href); self.location.href='categorylist?pgender=${param.pgender}';"> 
