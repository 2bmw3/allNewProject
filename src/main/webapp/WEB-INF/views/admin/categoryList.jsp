					...
					<div class="single-products" style="margin-top: 2%">
						<div class="productinfo text-center">
							...
							<c:forEach items="${categoryList}" var="vo">
								<div class="col-md-4">
									<a
										href="view?pno=${vo.pno}&pageNum=${pageNum}&jspName=${jspName}&ppkind=${ppkind}">
										<img style='width: 250px; height: 250px;'
										src="https://firebasestorage.googleapis.com/v0/b/project-26bd6.appspot.com/o/products%2F
${vo.ptitlephoto}?alt=media&token=42abbd59-4fb8-4db9-8c06-88d563ca1b6e">
									</a>

									<div>
										<input type="hidden" value="${vo.pno}"> <a
											href="productsUpdate?pno=${vo.pno}&pageNum=${pageNum}&jspName=${jspName}&ppkind=${ppkind}"
				...
				<ul class="pagination">
					...
					<c:if test="${page.prevPage==1}">
						<li value='${page.minimumPage-1}'><a href=""
							data-toggle="tab"><i class="fa fa-angle-double-left"></i></a></li>
					</c:if>
					...
					<c:if test="${page.nextPage==1}">
						<li value='${page.maxmumPage+1}'><a href="" data-toggle="tab"><i
...
<script src="/resources/admin/js/admin/categoryListJs.js"></script>
