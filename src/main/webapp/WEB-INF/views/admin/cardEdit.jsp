	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="features_items" style='margin-top: -73px;'>
				<div class="row">
					<form method='get' action='listSearchAction' id='search'>
						<div class="col-md-1" style='float: right;'>
							<button id="sBtn">
								<i class="fa fa-search" style="width: 15px; height: 21px"></i>
							</button>
						</div>
				...
				<div class="col-sm-10"
					style="margin-left: 60%; margin-top: 1%; display: none;" id="color">
				...
				<br> <br>
				<div class="single-products col-md-10" style="margin-top: 2%; margin-left: -5%;">
						...
						<c:if test="${'[null]' ne list}">
							<c:forEach items="${list}" var="vo" varStatus="status">
								...
								<div class="col-md-6 cardBackground">
									<img src='/resources/admin/images/card/card.png' style="width: 400px; height:300px;">

									<div class='logoImg' style="font-size: 15px; margin-left: -11%;">
										...
										<p style="margin-top: 10%;">Tel . ${phonenumber}</p>
										<p>Address . ${shopaddress}</p>
									</div>

									<div class='titleImg' style="margin-left: 4.5%;">
										...
										<p>${vo.pname}</p>
										<p>￦ ${vo.price}</p>
										<p>${colorCnt[status.count - 1]}color/
